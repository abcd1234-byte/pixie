...
#define PIXIE_DISPLAYS "/opt/pixie/displays"

/* Directory where we store documentation */
#define PIXIE_DOCS "/opt/pixie/doc"

/* Directory where we store modules */
#define PIXIE_MODULES "/opt/pixie/modules"

/* Directory where we store procedurals */
#define PIXIE_PROCEDURALS "/opt/pixie/procedurals"

/* Directory where we store ribs */
#define PIXIE_RIBS "/opt/pixie/ribs"

/* Directory where we store shaders */
#define PIXIE_SHADERS "/opt/pixie/shaders"

/* Directory where we store textures */
#define PIXIE_TEXTURES "/opt/pixie/textures"
